...
class FlightBookingResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'booking_exchange_rate' => $this->booking_exchange_rate !== null ? (float) $this->booking_exchange_rate : null,
            'base_currency_amount' => $this->base_currency_amount !== null ? (float) $this->base_currency_amount : null,
