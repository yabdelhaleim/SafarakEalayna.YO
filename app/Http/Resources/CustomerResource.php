...
class CustomerResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        // Per-module debt aggregates. Only `bus_*` is currently meaningful —
        // `flight_*` aggregates were reverted because flight_bookings does
        // not have total_price/paid_amount columns; consumers reading
        // flight_remaining_debt should use customer.balance instead.
        ...
        return [
            ...
            // flight_remaining_debt intentionally NOT exposed — its source columns
            // (flight_bookings.total_price/paid_amount) don't exist; expose via
            // a correct accessor/service if you reintroduce this later.
