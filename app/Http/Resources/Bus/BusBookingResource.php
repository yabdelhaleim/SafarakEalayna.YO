...
class BusBookingResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'payment_status' => $paymentStatus?->value ?? $this->payment_status,
            ...
            'refund' => $this->whenLoaded('refund', fn () => $this->refund ? [
                'id' => $this->refund->id,
                'company_penalty' => (float) $this->refund->company_penalty,
                'office_penalty' => (float) $this->refund->office_penalty,
                'total_paid' => (float) $this->refund->total_paid,
                'refund_amount' => (float) $this->refund->refund_amount,
                'status' => $this->refund->status,
                'notes' => $this->refund->notes,
                'account_id' => $this->refund->account_id,
                'processed_at' => $this->refund->processed_at?->format('Y-m-d H:i:s'),
            ] : null),
