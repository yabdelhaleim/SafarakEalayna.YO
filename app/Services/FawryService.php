...
class FawryService
{
    public function create(array $data): FawryTransaction
    {
        return FawryTransaction::query()->create($data);
    }

    public function update(FawryTransaction $record, array $data): FawryTransaction
    {
        $record->update($data);
    ...
    public function delete(FawryTransaction $record): bool
    {
    ...
    public function getById(int $id): FawryTransaction
    {
        return FawryTransaction::query()->with('employee')->findOrFail($id);
    }

    public function getDailyReport(Carbon $date): array
    {
        $query = FawryTransaction::query()->whereDate('created_at', $date->toDateString());
