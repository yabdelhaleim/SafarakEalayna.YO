...
| FM-G09-RG | Reject HTTP non-EGP booking at payBooking | FAIL | 3 |  |
...
| FM-G36-RG | Reject USD booking→EGP wallet (HTTP layer) | FAIL | 3 |  |
| FM-G37-RG | Reject USD booking→EGP cashbox FX (HTTP layer) | FAIL | 3 |  |
| FM-G38-RG | Reject SAR booking→EGP wallet (HTTP layer) | FAIL | 3 |  |
| FM-G39-RG | Reject SAR booking→EGP cashbox FX (HTTP layer) | FAIL | 2 |  |
| FM-G40-RG | Reject KWD booking high-rate (HTTP layer) | FAIL | 3 |  |
...
| FM-67 | Customer AR net = sale - payment - reversal | PASS | 3 | ar_start=1850.00 after_pay=1650.00 after_cancel=1650.00 expected_Δ=-200.00 |
