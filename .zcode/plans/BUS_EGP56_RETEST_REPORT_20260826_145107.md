...
| FM-G09-RG | Reject HTTP non-EGP booking at FormRequest | FAIL | 2 | {"amount":["The payment amount is required."],"payment_method":["The payment met |
...
| FM-33 | Cash inventory delete reverses expense | FAIL | 5 | tx_delta=0 cashbox_Δ_create=-400.00 cashbox_Δ_delete=0.00 |
...
| FM-G36-RG | Reject USD booking→EGP wallet at HTTP | FAIL | 2 | {"amount":["The payment amount is required."],"payment_method":["The payment met |
| FM-G37-RG | Reject USD booking→EGP cashbox FX at HTTP | FAIL | 2 | {"amount":["The payment amount is required."],"payment_method":["The payment met |
| FM-G38-RG | Reject SAR booking→EGP wallet at HTTP | FAIL | 2 | {"amount":["The payment amount is required."],"payment_method":["The payment met |
| FM-G39-RG | Reject SAR booking→EGP cashbox FX at HTTP | FAIL | 2 | {"amount":["The payment amount is required."],"payment_method":["The payment met |
| FM-G40-RG | Reject KWD booking high-rate at HTTP | FAIL | 2 | {"amount":["The payment amount is required."],"payment_method":["The payment met |
